...
computer = Computer("AMD Ryzen 5 5500U",512)
...
class Phone:
    ...
    def __call__(self, call_to_number, sim_cards_number):
        self.call_to_number = call_to_number
        self.sim_cards_list = sim_cards_number
        if sim_cards_number == "1":
            ...
            print("Ошибка!!!")
phone = Phone({1 == "O!", 2 == "Beeline"})
phone.__call__(input("Введите номер телефона:"),input("Выберите сим карту(1 - Beeline, 2 - O!):"))
...
class SmartPhone(Computer, Phone):
    ...
    def __str__(self):
        return f"Процессор - {self.cpu}. Памяти на компьютере - {self.memory}Гб"
